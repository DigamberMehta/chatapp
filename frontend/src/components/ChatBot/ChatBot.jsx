...
const ChatBot = ({ isOpen, onClose }) => {
  ...
  return (
    <div
      className="fixed z-40 bottom-[calc(4rem+1.5rem)] right-0 mr-4 bg-white p-6 rounded-lg border border-[#e5e7eb] w-[440px] h-[634px]"
    ...
    >
      ...
      <div className="pr-4 h-[474px]" style={{ minWidth: '100%', display: 'table' }}>
        ...
        <div className="flex gap-3 my-4 text-gray-600 text-sm flex-1">
          ...
          <p className="leading-relaxed">
            <span className="block font-bold text-gray-700">You</span> Hello, I need help!
          </p>
        </div>
      </div>
